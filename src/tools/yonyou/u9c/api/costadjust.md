...
private List<CommonArchiveDataDTO> CreateCostAdjust(string itemCode, string orgCode, decimal money)
{
    try
    {
...
private void CommitCostAdjust(string docNo)
{
    try
    {
...
/// </summary>
/// <param name="docNo">成本调整单号</param>
private void ApproveCostAdjust(string docNo)
{
    try
    {
