...
对文件夹`C:\Program Files\Microsoft SQL Server Reporting Services\SSRS\ReportServer`设置`everyone`权限

- 添加`UFRPT`插件支持

打开文件`C:\Program Files\Microsoft SQL Server Reporting Services\SSRS\ReportServer\rsreportserver.config`

在`Data`节点下添加`<Extension Name="UFRPT" Type="UFSoft.UBF.Report.ExtendLibrary.ReportConnection,UFSoft.UBF.Report.DataProviderForRS"/>`
...
### Visual Studio 2026
  ...
  U9C最新使用.NETFramework 4.8框架，之前使用.NET Framework 4.5 使用Visual Studio 2019
