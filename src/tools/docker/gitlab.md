...
![Gitlab](https://image.ilyl.life:8443/gitlab/docker-desktop-gitlab.png)

映射80端口即可，例如:8888

![Gitlab](https://image.ilyl.life:8443/gitlab/docker-desktop-gitlab-container.png)

浏览器输入`http://localhost:8888`即可现在gitlab管理页面

如果浏览器不显示，等待片刻或者重启等待即可。

![登陆界面](https://image.ilyl.life:8443/gitlab/gitlab-ui-login.png)
...
![默认密码](https://image.ilyl.life:8443/gitlab/gitlab-root-password.png)
...
![英文界面](https://image.ilyl.life:8443/gitlab/gitlab-ui.png)

点击头像，选择`Preferences`

![偏好](https://image.ilyl.life:8443/gitlab/gitlab-setting.png)

下拉找到`Language`

![语言选择](https://image.ilyl.life:8443/gitlab/gitlab-set-chinese.png)

保存后刷新即可。

![中文界面](https://image.ilyl.life:8443/gitlab/gitlab-ui-zh-hans.png)

### 克隆仓库

在Gitlab创建仓库之后，http只能拉取`公开`的项目，使用VS进行项目克隆，创建项目，在提交，一切正常。

![仓库](https://image.ilyl.life:8443/gitlab/gitlab-repo.png)
