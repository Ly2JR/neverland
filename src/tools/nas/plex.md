...
4. 输入转换`openssl pkcs12 -export -out x:\your_domain.pfx -certpbe AES-256-CBC -keypbe AES-256-CBC -macalg SHA256 -inkey x:\your_domain.key -in x:\your_domain.pem -password pass:your_secret_key`
5. 生成新的`new.pfx`文件
6. 在Plex设置里找到`网络`
