import{_ as c}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as l,o as p,c as i,f as u,w as a,b as k,e as s,d as n}from"./app-I-9Z-FqE.js";const r={},m=k("<p>参与此模式的类和对象包括：</p><ul><li><p>Memento(<code>Memento</code>)</p><ul><li>存储Originator对象的内部状态。Memento可以根据其发起者的判断，尽可能多地或尽可能少地存储发起者的内部状态。</li><li>防止发起者以外的对象访问。Mementos实际上有两个接口。Caretaker看到了Memento的狭窄接口---它只能将Memento传递给其他对象。相比之下，originator看到了一个广泛的界面，它可以访问所有必要的数据以将自己恢复到之前的状态。理想情况下，只有产生备忘录的始发者才被允许访问备忘录的内部状态。</li></ul></li><li><p>Originator(<code>SalesProspect</code>)</p><ul><li>创建一个包含其当前内部状态快照的Memento。</li><li>使用Memento恢复其内部状态。</li></ul></li><li><p>Caretaker(<code>Caretaker</code>)</p><ul><li>负责Memento的保管。</li><li>从不操作或检测Memento的内容。</li></ul></li></ul>",2),d=n("div",{class:"language-csharp line-numbers-mode","data-ext":"cs"},[n("pre",{class:"language-csharp"},[n("code",null,[n("span",{class:"token comment"},"// 演示了临时保存和恢复另一个对象的内部状态的备忘录模式"),s(`
