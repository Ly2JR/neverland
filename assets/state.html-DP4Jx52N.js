import{_ as o}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,o as p,c as i,a as u,w as a,e as k,f as s,d as n}from"./app-C2YhVZ4q.js";const r={},d=k("<p>参与此模式的类和对象包括：</p><ul><li><p>Context(Account)</p><ul><li>定义客户感兴趣的接口</li><li>维护定义当前状态的ConcreteState子类的实例。</li></ul></li><li><p>State(State)</p><ul><li>定义了一个接口，用于封装与上下文的特定状态相关的行为。</li></ul></li><li><p>Concrete State(RedState,SilverState,GoldState)</p><ul><li>每个子类实现与上下文状态相关联的行为。</li></ul></li></ul>",2),m=n("div",{class:"language-csharp line-numbers-mode","data-ext":"cs","data-title":"cs"},[n("pre",{class:"language-csharp"},[n("code",null,[n("span",{class:"token comment"},"// 演示了状态模式。"),s(`
