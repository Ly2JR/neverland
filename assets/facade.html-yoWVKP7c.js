import{_ as c}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as l,o as p,c as i,f as u,w as a,b as k,e as s,d as n}from"./app-zrtoNGv7.js";const r={},d=k("<p>参与此模式的类和对象包括：</p><ul><li><p>Facade(<code>MortgageApplication</code>)</p><ul><li>知道哪些子系统类负责请求。</li><li>将客户端请求委托给适当的子系统对象。</li></ul></li><li><p>Subsystem classes(<code>Bank</code>,<code>Credit</code>,<code>Loan</code>)</p><ul><li>实现子系统功能。</li><li>处理由Facade对象分配的工作。</li><li>对外观一无所知，也不对其进行参考。</li></ul></li></ul>",2),m=n("div",{class:"language-csharp line-numbers-mode","data-ext":"cs"},[n("pre",{class:"language-csharp"},[n("code",null,[n("span",{class:"token doc-comment comment"},"/// 演示了外观模式。"),s(`
